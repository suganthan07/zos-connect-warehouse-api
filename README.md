...
This is a complete z/OS Connect API project as generated by the Designer:

src/main/
├── api/
│   └── openapi.yaml              ← OpenAPI 3.0 specification
├── liberty/config/
│   └── server.xml                ← z/OS Connect Liberty server config
├── operations/                   ← REST-to-COBOL mapping definitions
├── resources/
│   └── ITEMDET.cpy               ← COBOL copybook for CICS COMMAREA
├── zosAssets/                    ← z/OS Asset bindings
└── web.xml                       ← Web deployment descriptor

Dockerfile             ← For containerized deployment
build.gradle           ← Gradle build configuration
zapp.yaml              ← z/OS application descriptor
